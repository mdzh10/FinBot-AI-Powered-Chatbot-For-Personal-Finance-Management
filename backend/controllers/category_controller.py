...
from schemas.category_schema import BaseResponse, CategoryCreate, CategoryDetails, CategoryResponse
...
async def get_categories(category_id: Optional[int] = None, db: Session = Depends(get_db)):
    try:
...
# Modify Category
@router.put("/update", response_model=CategoryResponse, operation_id="update_category_details")
...
# Delete Category
@router.delete("/delete/{category_id}", response_model=BaseResponse, operation_id="delete_category")
