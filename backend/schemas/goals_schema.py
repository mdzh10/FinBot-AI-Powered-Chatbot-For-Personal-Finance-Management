...
class GoalUpdate(BaseModel):
    goal_period: Optional[GoalPeriodEnum] = None  # Optional field for goal period update
    spending_limit: Optional[float] = None  # Optional field for spending limit update
    updated_at: Optional[datetime] = None  # Optional; usually auto-updated but can be overridden
