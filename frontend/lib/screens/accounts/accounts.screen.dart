              ...
              return Stack(
                children: [
                              ...
                              Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      CurrencyText(account.credit??0, style:  const TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: ThemeColors.success),)
                                    ],
                                  )
                              ),
                              Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      CurrencyText(account.debit??0, style:  const TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: ThemeColors.error),)
                  ...
                  Positioned(
                      right: 15,
                      bottom: 40,
                      child: Icon(Icons.account_balance_outlined, size: 20, color: Colors.white,)
                  ),
                              ...
                              PopupMenuItem<String>(
                                ...
                                onTap: (){
                                  WidgetsBinding.instance.addPostFrameCallback((_) {
                                    showDialog(context: context, builder: (builder)=>AccountForm(account: account, userId: widget.userId,));
                                  });
                                },
                              ),
                              PopupMenuItem<String>(
